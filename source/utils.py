...
from source.trainer import dataset_classes
import argparse
...
class ForeverDataIterator:
    ...
    def __next__(self):
        try:
            ...
            print('COMPLETION OF SINGLE PASS THROUGH DATA')
            self.iter = iter(self.data_loader)
            data = next(self.iter)
        return data
...
def get_dataset_classnames(dataset, args):
    if dataset == 'ImageNet':
        return get_imagenet_classnames()
